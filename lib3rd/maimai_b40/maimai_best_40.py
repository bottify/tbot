...
titleFontName = 'static/adobe_heiti.otf'
...
class DrawBest(object):
    ...
    def __init__(self, sdBest:BestList, dxBest:BestList, userName:str, playerRating:int, musicRating:int):
        ...
        self.cover_dir = 'static/mai/cover/UI_Jacket_'
    ...
    def _drawRating(self, ratingBaseImg:Image.Image):
        ...
        while theRa:
            ...
            ratingBaseImg.paste(digitImg, (COLOUMS_RATING[i] - 2, 12), mask=digitImg.split()[3])
            i = i - 1
    ...
    def draw(self):
        ...
        namePlateDraw.text((18, 2), ' '.join(list(self.userName)), 'black', font1)
        ...
        font2 = ImageFont.truetype(titleFontName, 14, encoding='utf-8')
